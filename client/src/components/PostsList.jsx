...
import gridThree from '../images/grid_tree.svg';
...
const PostsList = () => {
    ...
    return (
        ...
        <Button variant="text" size="small" onClick={() => setLayout(gridThree)}>
            <img src={gridThree} alt="Three Column Grid Icon" style={{background : layout === "gridThree" ? "#ccc" : ""}}/>
        </Button>
        <Button variant="text" size="small" onClick={() => setLayout("gridFour")}>
            <img src={gridFour} alt="Four Column Grid Icon" style={{background : layout === "gridFour" ? "#ccc" : ""}}/>
        </Button>
